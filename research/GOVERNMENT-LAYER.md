...
| Item | Detail | Label |
|---|---|---|
| **Minister of State for Artificial Intelligence and New Technologies** | **Rick Glumac.** Post reported created 2025-07-17 — British Columbia has a dedicated AI portfolio at the minister-of-state level. | Tier B — reported by the human research pass, not fetch-verified here |
| **Cabinet shuffle** | 2026-08-14. Moved several relevant portfolios. **Any source naming Ravi Kahlon as Minister of Jobs and Economic Growth is now out of date.** | Tier B |
