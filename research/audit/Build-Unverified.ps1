...
$CHECKED = @(
  ...
  @{ name='Quantum Algorithms Institute (legacy domain)'; url='https://www.quantumalgorithms.ca'; status='rejected'; reason='RESOLVED IN THE RECONCILE PASS. quantumalgorithms.ca is the LEGACY domain and served an expired TLS certificate on 2026-08-19. The live domain is qai.ca, confirmed by fetch. The institute IS published, now sourced to https://www.qai.ca/who-we-are. A further variant, quantumalgorithms.org, appears in the predecessor dataset and is also wrong. Recorded so the dead domains are not re-adopted.' },
  @{ name='HIVE Digital Technologies'; url='https://www.hivedigitaltechnologies.com/'; status='unverified'; reason='Parent of BUZZ HPC, which IS published as an operator of BC AI infrastructure at Merritt. AI/HPC materiality confirmed verbatim on HIVE''s own site ("GPU-based accelerated AI computing", "thousands of next-generation GPUs ... to support the fast-growing AI and HPC markets"). But the page read 2026-08-19 states NO headquarters city, province or address, so BC presence for the parent company is not established. Its BC activity is captured on the BUZZ HPC record instead.' },
  @{ name='DigiBC'; url='https://digibc.org'; status='unverified'; reason='Tier-A verified by hand: registered non-profit industry association for BC creative technology, 160-577 Great Northern Way, Vancouver. Not published because no AI or machine-learning statement was sourced -- its remit is video games, animation, VFX, XR and virtual production. Held to the same bar as AbCellera and Innovate BC. NOTE FOR ANY FUTURE PASS: DigiBC was founded in 1997 as New Media BC and renamed in January 2009, so "New Media BC" must be treated as a name variant of DigiBC and never listed as a live separate organization.' },
  @{ name='New Media BC'; url='https://newmediabc.com'; status='rejected'; reason='DEFUNCT PREDECESSOR NAME, not a live organization. DigiBC''s own history states it was founded in 1997 as New Media BC, with a merger and renaming in January 2009. The predecessor dataset carries it as a live organization with a named Executive Director who is not DigiBC''s. Merge as a name variant of DigiBC; never list separately.' },
  @{ name='Allied Properties REIT'; url='https://www.telus.com/en/business/medium-large/ai/sovereign-ai-factory'; status='unverified'; reason='Named as a co-developer of the TELUS 150 West Georgia AI factory site. No location or AI-activity page for the company itself was read, so no record was created; the partnership is recorded in that facility''s sourced description instead.' },
  ...
  @{ name='1QBit'; url='https://1qbit.com'; status='unverified'; reason='Legally 1QB Information Technologies Inc. Its /contact/ path returns HTTP 404 and its homepage, read 2026-08-19, carries no city, province or address anywhere including the footer -- only a copyright line. Quantum design work is confirmed on the page; BC presence is not. One first-party page naming Vancouver would settle it.' },
  @{ name='BrainStation'; url='https://brainstation.io/campus/vancouver'; status='unverified'; reason='Its own Vancouver campus page, read 2026-08-19, names AI and data-science certifications but contains NO mention of Vancouver, British Columbia or any address -- on the page whose whole purpose is that campus. A national bootcamp chain whose campus page will not state the campus city cannot be verified under this project rules. Worth retrying against a location or contact page.' },
  @{ name='Semios'; url='https://semios.com'; status='unverified'; reason='Vancouver agricultural-technology company. Its /contact-us/ page returned HTTP 403 to automated fetch on 2026-08-19, as it did on the earlier pass. Blocked, not absent -- this is a bot-protection failure rather than a finding about the company.' },
  @{ name='Coast Mountain College'; url='https://libguides.coastmountaincollege.ca/artificial-intelligence'; status='unverified'; reason='SECOND ATTEMPT at the only region with zero records. Its AI library guide, read 2026-08-19, describes "A look at artificial intelligence: what it is and how to use it ethically in your work" but names NO city, campus or BC address anywhere on the page. The college homepage confirmed campuses at Terrace, Prince Rupert, Smithers, Hazelton and Haida Gwaii but stated no AI activity. North Coast & Nechako therefore still holds no record. See COVERAGE.md section 1.1.' }
)
